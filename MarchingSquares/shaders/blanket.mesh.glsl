...
#error "Read note here"
/* 
 * NOTE this implementation is bad.
 * Requires enabling CELL_INDICES_ENCODE.
 * It uses an incredibly weird vertex
 * layout and actually wastes vertices.
 * Was originally made for vertex sharing
 * which works...
 * 
 * ... but normals aren't going to be easy...
 * 
 * If you feel like messing with this, go
 * ahead and delete the error message.
 */
...
//#ifndef DRAW_DATA_MEASURE
//#define DRAW_DATA_MEASURE false
//#endif
